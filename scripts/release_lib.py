...
ROUTING_REMINDER = (
    ...
    'not classify it as merely informational. An execution request needs an actionable plan before '
    'mutation or substantial execution. Begin the routing note with a Markdown divider and '
    'localized Adaptive Task Routing resource-guidance heading, then action and reason. Preserve '
    'enabled conversation/window advice. Default compact output distinguishes task fit from the '

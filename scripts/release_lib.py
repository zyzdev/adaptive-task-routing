...
AUTO_ACTIVATION = {
    ...
    "gemini": (
        ...
        "resource-guidance heading. Include the enabled conversation recommendation, explicit "
        "yes/no window-switch answer and reason before the AI-setting blocks; retaining or deferring "
        "a model change does not omit the conversation result. Use the complete note below. "
